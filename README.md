...
profile app-server's ChatGPT-auth-required flag on Linux, since that flag can be
set by custom-provider profiles even while the Desktop app is signed in.
